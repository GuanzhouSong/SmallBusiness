...
public class PubScagentServiceImpl extends MyBatisServiceSupport implements IPubScagentService {
	...
	public boolean savePubScagentNoRepeat(PubScagent pubScagent) throws Exception {
		...
		example.createCriteria().andEqualTo("agentNO",pubScagent.getAgentNO()).andEqualTo("deptCode",pubScagent.getDeptCode());
	 ...
	 */
	@Override
	public JSONObject saveExcelBatch(InputStream in, SysUser sysUser,String localAdm) throws Exception {
        ...
        Map<String,String> expertFlagMap = getExpertFlagMap();
        Map<String,String> studyLevelMap = getStudyLevelMap();
        Map<String,String> agentSexMap = getAgentSexMap();
        Map<String,String> deptCatgMap = getDeptCatgMap();
        Map<String,String> stationTermMap = getStationTermMap();
			...
			for(PubScagent pubScagent : pubScagentList){
				try{
					...
					if(StringUtils.isNotEmpty(agentNO)){
						Example example=new Example(PubScagent.class);
						example.createCriteria().andEqualTo("agentNO",agentNO).andEqualTo("deptCode",deptCode);
						...
						if(pubScagentListR != null && pubScagentListR.size() > 0){
							...
							if(pubScagentR.getId() != null && pubScagentR.getId() > 0){
								message += num+".证件号码【"+agentNO+"】重复；<br/>";
								num++;
     ...
     * @return
     */
    public List<PubScagent> excelTranslateRegNO(InputStream in,String deptCode,SysUser sysUser,String localAdm,String message){
    	try {
			//解析excel
			Workbook workbook = WorkbookFactory.create(in);
			Sheet sheet = workbook.getSheetAt(0);
            ...
            Map<String,String> agentPositionMap = getAgentPositionMap();
            Map<String,String> agentStateMap = getAgentStateMap();
//            Map<String,String> agentRangeMap = getAgentRangeMap();
...
//    }
     ...
     * @return
     */
    private Map<String,String> getDeptCatgMap(){
    	Map<String,String> studyLevelMap = new HashMap<String, String>();
    	studyLevelMap.put("工商行政管理类", "1");
    	studyLevelMap.put("食品药品管理类", "2");
    	studyLevelMap.put("质量技术监督类", "3");
    	studyLevelMap.put("安全生产类", "4");
    	studyLevelMap.put("物价管理类", "5");
    	return studyLevelMap;
    }
     ...
     * @return
     */
    private Map<String,String> getStationTermMap(){
    	Map<String,String> studyLevelMap = new HashMap<String, String>();
    	studyLevelMap.put("保化检查员", "1");
    	studyLevelMap.put("药品检查员", "2");
    	studyLevelMap.put("医疗器械检查员", "3");
    	studyLevelMap.put("特种设备安全监察员", "4");
    	return studyLevelMap;
    }
     ...
     * @return
     */
    private Map<String,String> getExpertFlagMap(){
    	Map<String,String> unitTypeMap = new HashMap<String, String>();
    	unitTypeMap.put("保化组长", "1");
    	unitTypeMap.put("药品GSP", "2");
    	unitTypeMap.put("药品GMP", "3");
    	unitTypeMap.put("医疗器械GSP", "4");
    	unitTypeMap.put("医疗器械GMP", "5");
    	return unitTypeMap;
    }
