...
public class PubScCheckBill implements Serializable {
     ...
     * 检查子项编码
     */
    @Column(name = "CheckLittleItemCode")
    private String checkLittleItemCode;

    /**
     * 检查子项名称
     */
    @Column(name = "CheckLittleItemDesc")
    private String checkLittleItemDesc;
     ...
     * 获取检查子项编码
     *
     * @return CheckLittleItemCode - 检查子项编码
     */
    public String getCheckLittleItemCode() {
        return checkLittleItemCode;
    }

    /**
     * 设置检查子项编码
     *
     * @param checkLittleItemCode 检查子项编码
     */
    public void setCheckLittleItemCode(String checkLittleItemCode) {
        this.checkLittleItemCode = checkLittleItemCode;
    }

    /**
     * 获取检查子项名称
     *
     * @return CheckLittleItemDesc - 检查子项名称
     */
    public String getCheckLittleItemDesc() {
        return checkLittleItemDesc;
    }

    /**
     * 设置检查子项名称
     *
     * @param checkLittleItemDesc 检查子项名称
     */
    public void setCheckLittleItemDesc(String checkLittleItemDesc) {
        this.checkLittleItemDesc = checkLittleItemDesc;
    }
