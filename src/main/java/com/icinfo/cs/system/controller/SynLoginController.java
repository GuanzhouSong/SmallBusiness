...
import com.icinfo.cs.common.constant.LogTypeEnum;
...
import com.icinfo.cs.system.dto.LogDto;
...
import com.icinfo.cs.system.service.*;
...
public class SynLoginController extends CSBaseController {
    ...
    public String loginSynPage() throws Exception {
        return "/syn/login";
    }
