        ...
        if (StringUtils.isNotEmpty(id)) {//修改时
            ...
            if (StringUtils.isNotEmpty(sid)) {
                ...
                if (_temp != null) {
                    ...
                    String nextAdCode=sysDepartService.doNextAdCode(_temp.getOrgCoding());//新增时获取下一个adCode值
                    String nextOrgCode=sysDepartService.doNextOrgCoding(_temp.getOrgCoding());//新增时获取下一个OrgCoding
