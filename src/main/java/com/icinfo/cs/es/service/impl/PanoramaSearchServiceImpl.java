...
public class PanoramaSearchServiceImpl implements IPanoramaSearchService {
	...
	// 需要模糊搜索的列
	private static final String[] nameArrWild = new String[] { "entName", "isOpan", "dom", "opScope", "licNameAft", "liaName" };
	...
	private static final String[] nameArrMatchBool = new String[] { "isCase", "isSim", "leRepIsLim", "isIndRegObj", "isFocusObj",
			"isRiskWarn" };
	...
	public PanoramaSearch selectOnePanorama(String priPID) throws Exception {
		return panoramaSearchMapper.selectOnePanorama(priPID);
