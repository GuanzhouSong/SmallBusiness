...
public class ImInfoSearchController extends CSBaseController {
	...
	public ModelAndView toDetail(String priPID,String leRep,String liaName,String imPubDate,
			String tel,String liaTel) throws Exception {
	...
	public ResponseEntity<byte[]> createPdf(HttpServletRequest request, String priPID,String leRep,String tel,String liaName,
			String liaTel,String imPubDate)
			throws Exception { 
