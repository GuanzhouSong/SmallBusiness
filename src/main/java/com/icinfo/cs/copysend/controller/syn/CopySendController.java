 ...
 */
@Controller
@RequestMapping({"/syn/copysend/","/reg/server/copysend/"})
public class CopySendController extends BaseController {
	@Autowired
	...
	public ModelAndView doEnCopySend(String realtab,HttpSession session) throws Exception{
		ModelAndView mv = new ModelAndView("/syn/system/syncsupervise/copysend/cgcs_main");
	...
	public ModelAndView doEnSend(HttpSession session) throws Exception{
		ModelAndView mv = new ModelAndView("/syn/system/syncsupervise/copysend/cgcs_send");
		SysUserDto sysUser = (SysUserDto) session.getAttribute(Constants.SESSION_SYS_USER);
	...
	public ModelAndView doEnPrint(CopySendDto copySendDto) throws Exception{
		ModelAndView mv = new ModelAndView("/syn/system/syncsupervise/copysend/cgcs_print");
		return mv;
	}
	...
	public ModelAndView doEnAccept(HttpSession session) throws Exception{
		ModelAndView mv = new ModelAndView("/syn/system/syncsupervise/copysend/cgcs_accept");
		SysUserDto sysUser = (SysUserDto) session.getAttribute(Constants.SESSION_SYS_USER);
	...
	public ModelAndView doEnNocardItem(HttpSession session) throws Exception {
		ModelAndView mv = new ModelAndView("syn/system/syncsupervise/copysend/cgcs_nocarditem");
		SysUserDto sysUser = (SysUserDto) session.getAttribute(Constants.SESSION_SYS_USER);
	...
	public ModelAndView doEnSendView(HttpSession session) throws Exception {
		ModelAndView mv = new ModelAndView("syn/system/syncsupervise/copysend/cgcs_view");
		SysUserDto sysUser = (SysUserDto) session.getAttribute(Constants.SESSION_SYS_USER);
	...
	public ModelAndView doAddCopySend(HttpSession  session) throws Exception{
		ModelAndView mv = new ModelAndView("/syn/system/syncsupervise/copysend/cgcs_add");
		SysUserDto sysUser = (SysUserDto) session.getAttribute(Constants.SESSION_SYS_USER);
	...
	public ModelAndView addIllegal(String state,HttpSession session) throws Exception{
		ModelAndView mv = new ModelAndView("/syn/system/syncsupervise/copysend/cgcs_check_out");
		SysUserDto sysUser = (SysUserDto) session.getAttribute(Constants.SESSION_SYS_USER);
	...
	public ModelAndView doEnDepartTree(HttpSession session) throws Exception{
		ModelAndView mv = new ModelAndView("/syn/system/syncsupervise/copysend/departtree");
		SysUserDto sysUser = (SysUserDto) session.getAttribute(Constants.SESSION_SYS_USER);
	...
	public ModelAndView doEnFeedback(HttpSession session,String copyFormNo) throws Exception{
		ModelAndView mv = new ModelAndView("/syn/system/syncsupervise/copysend/cgcs_fk");
		SysUserDto sysUser = (SysUserDto) session.getAttribute(Constants.SESSION_SYS_USER);
	...
	public ModelAndView doEnRefer(HttpSession session,String copyFormNo) throws Exception{
		ModelAndView mv = new ModelAndView("/syn/system/syncsupervise/copysend/cgcs_cy");
		Map<String, Object> qryMap = new HashMap<String,Object>();
		qryMap.put("copyFormNo", copyFormNo);
		CopySendDto copySendDto = copySendService.selectCopySend(qryMap);
		SysUserDto sysUser = (SysUserDto) session.getAttribute(Constants.SESSION_SYS_USER);
	...
	public ModelAndView doEnEdit(HttpSession session,String copyFormNo) throws Exception{
		ModelAndView mv = new ModelAndView("/syn/system/syncsupervise/copysend/cgcs_edit");
		Map<String, Object> qryMap = new HashMap<String,Object>();
		qryMap.put("copyFormNo", copyFormNo);
		CopySendDto copySendDto = copySendService.selectCopySend(qryMap);
		SysUserDto sysUser = (SysUserDto) session.getAttribute(Constants.SESSION_SYS_USER);
	...
	public ModelAndView doReview(String copyFormNo,HttpSession session) throws Exception{
		ModelAndView mv = new ModelAndView("/syn/system/syncsupervise/copysend/cgcs_sh");
		Map<String, Object> qryMap = new HashMap<String,Object>();
		qryMap.put("copyFormNo", copyFormNo);
		SysUserDto sysUser = (SysUserDto) session.getAttribute(Constants.SESSION_SYS_USER);
		CopySendDto copySendDto = copySendService.selectCopySend(qryMap);
