...
public class RegistInfoHis  implements Serializable   {
  ...
  //企业联络员联系电话
     ...
     *
     * @param registState 分配状态：1未分配；2已分配；3退回待分配
     */
     ...
     * 设置建档状态：0未建档；1已建档
     *
     * @param archState 建档状态：0未建档；1已建档
     */
     ...
     *
     * @param claimState 认领状态：0未认领；1已认领；2超时未认领；3超时认领
     */
     ...
     * 设置是否进行实地勘察：0否1是
     *
     * @param isInvestigate 是否进行实地勘察：0否1是
     */
     ...
     *
     * @param isSameAddr 经营场所地址与实地是否一致：0不一致1一直
     */
     ...
     *
     * @param diffAddrReason 经营场所与实地不一致原因：0查无下落，1商务秘书公司代理，2异地经营
     */
     ...
     * 设置是否变更重建档0否1是
     *
     * @param isChangeArch 是否变更重建档0否1是
     */
     ...
     *
     * @param changeArchState 变更重建档类型：1内外资转型，2被撤消（吊销）恢复，3个转企，4个转企&新迁入
     */
     ...
     *
     * @param registSource 分配来源(委托状态)：1委托,2自管，3系统自动
     */
     ...
     * 设置时间戳（建档日期，建档时候更新）
     *
     * @param createTime 时间戳（建档日期，建档时候更新）
     */
     ...
     * 设置受托管辖机关名称
     *
     * @param delegateOrgName 受托管辖机关名称
     */
