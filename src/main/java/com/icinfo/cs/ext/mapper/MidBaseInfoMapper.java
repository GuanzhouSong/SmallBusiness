...
public interface MidBaseInfoMapper extends Mapper<MidBaseInfo> {
     ...
     * @date 2016年8月29日
     */
    MidBaseInfoDto selectMidBaseInfoByPripidForLogin(@Param("pripid") String pripid, @Param("systemType") String systemType, @Param("regState") String regState);
     ...
     * @date 2016年8月29日
     */
    MidBaseInfoDto selectByRegnoAndEntname(@Param("regno") String regno, @Param("entname") String entname, @Param("systemType") String systemType, @Param("regState") String regState);
     ...
     * @date 2016年9月18日
     */
    MidBaseInfoDto selectMidBaseInfoByRegNOHold(String regNO);
     ...
     * @author baifangfang
     */
    List<MidBaseInfoDto> selectListByCondition(String condition);
