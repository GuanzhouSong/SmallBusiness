...
public class CsMessageServiceImpl extends MyBatisServiceSupport implements ICsMessageService {
    ...
    public void quartzJob() throws Exception{
        ...
        for ( int i = 1 ; i <= pageCount ; i++ ) {
            ...
            String json = "{\"title\" : \"企业工商年报提醒\", " + "\"pusher\" : \"国家企业信用信息公示系统\", " + "\"receiver\" : \"${tel}\"," + "\"sourceUrl\" : \"${url}\"," + "\"type\" : \"3\",   " + "\"subType\" : \"yr_notice\"," + "\"content\" : \"${content}\"," + "\"additionInfo\" : {" + "\"remark\" : \"ⓘ${lastYear}年度企业年报将于${nowyear}年6月30日截止，逾期将被列入经营异常名录并公示。\"," + "\"yrStatus\" : \"${reportType}\"  " + "}," + "\"pushChannels\" : \"1,2\"   " + "}";
