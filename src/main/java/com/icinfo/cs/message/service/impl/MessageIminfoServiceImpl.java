	                	...
	                	try {
		                	...
		                	if(entCount!=null&&entCount>0){
			                	...
			                	if(checkTel(tel)){
					                    ...
					                    String json = "{\"title\" : \"企业即时信息公示提醒\", " + "\"pusher\" : \"国家企业信用信息公示系统\", " + "\"receiver\" : \""+tel+"\"," + "\"sourceUrl\" : \""+url+"/message/messageiminfo/toMessageImInfoView?msgReadTel="+tel+"&sendDate="+DateUtil.getDate ("yyyyMMdd")+"\"," + "\"type\" : \"3\",   " + "\"subType\" : \"yr_intime_notice\"," + "\"content\" : \""+content+"\"," + "\"additionInfo\" : {" + "\"toDo\" : \"完善企业即时信息（股东及出资信息）报送与公示\"," + "\"basicInfo\" : \"企业即时信息填报规范\","+ "\"sendTime\" : \""+DateUtil.getDate ("HH:mm")+"\"" + "}," + "\"pushChannels\" : \"1,2\"" + "}";
