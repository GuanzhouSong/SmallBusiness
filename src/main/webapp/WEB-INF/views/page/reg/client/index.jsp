    ...
    <div class="client-index-tab" data-component="tab">
        ...
        <div class="tab-header">
            <ul class="clearfix">
                ...
                <li><a href="javascript:void(0);" class="tab-item"><i class="tab-icon tab-icon4"></i>公务文书回执【<strong class="light" id="wenshu_total">0</strong>】</a></li>
            </ul>
        </div>
        ...
        <div class="tab-content mb20 mt10">
                        ...
                        <table class="table-public mt5">
                            ...
                            <tr>
                                <td class="focus-state">
                                    ...
                                    <div class="ipt-box js-ipt-box">
                                        <input type="text" name="" value="${sessionScope.midBaseInfoDto.regOrgName}" 
                                        class="ipt-txt w308" style="padding-left: 5px;text-align: left;" readonly="readonly">
                                        <i class="icon-close"></i>
                                    </div>
                                </td>
         ...
         <%--   <div class="tab-panel">
               ...
               <%@include file="writ/writ_list.jsp"%>
            </div>--%>
        </div>
