        ...
        <div class="form-list pd14-mr">
            ...
            <div class="form-item clearfix">
                ...
                <div class="col-4">
                    ...
                    <div class="col-7">
                        <div class="ipt-box col-12">
                            <select name="infoAuditResult" id="infoAuditResult">
                                <option value="">全部</option>
...
<div class="light-info">
    <span class="light">提示：此处仅查询本局登记及上级委托管辖的已补报核查录入的在册企业与农专社。 录入的检查信息审核通过后自动通过公示系统予以公示，审核不通过时则退回至“补报核查录入”功能里重新修改。
    </span>
</div>
...
<script src="/js/reg/server/inspect/checkinfo_list.js"></script>
</body>
</html>
