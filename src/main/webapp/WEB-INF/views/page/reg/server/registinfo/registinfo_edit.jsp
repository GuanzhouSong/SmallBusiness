            ...
            <div class="form-list">
                ...
                <div class="form-item clearfix" ${fromtype=='batch'?'style="display:none"':''}>
                    <div class="col-12">
                    	...
                    	<input type="text" id="info_address" class="ipt-txt inline-txt" name="opLoc" value="${empty registInfoDto.opLoc ? midBaseInfoDto.dom : registInfoDto.opLoc}" placeholder="" readonly size="157">
                    </div>
                </div>
                <div class="form-item clearfix" ${fromtype=='batch'?'style="display:none"':''}>
                    <div class="col-12">
                ...
                <div class="form-item clearfix" ${fromtype=='batch'?'style="display:none"':''}>
                    <div class="col-12">
                       	<label class="item-name col-2" style="font-size: 14px;"></label>
                    	<input type="text" id="info_actualaddress" class="ipt-txt inline-txt" name="actualOpLoc" value="${empty registInfoDto.actualOpLoc ? midBaseInfoDto.dom : registInfoDto.actualOpLoc}" placeholder="" readonly size="157">
                    </div>
                </div>
                <div class="form-item clearfix">
                    <div class="col-12">
                        ...
                        <input readonly id="sliceNONameDiv" class="ipt-txt inline-txt" value="${registInfoDto.sliceNOName}" size="143">
                ...
                <div class="form-item clearfix">
                    <div class="col-12">
                        ...
                        <input readonly id="sliceManp" class="ipt-txt inline-txt" value="${registInfoDto.sliceMan}" size="143">
                        <span style="float:right">
                ...
                <div class="form-item clearfix" ${fromtype=='batch'?'style="display:none"':''}>
                    <div class="col-12">
                        ...
                        <input type="text" name="unitTel" class="ipt-txt inline-txt" value="${registInfoDto.unitTel }" size="44"/>
                       	<span style="font-size:14px;margin-left: 35px;">企业电子邮箱：</span>
                       	<input type="text" name="unitEmail" class="ipt-txt inline-txt" value="${registInfoDto.unitEmail }" size="88"/>
                    </div>
                </div>
                <div class="form-item clearfix" ${fromtype=='batch'?'style="display:none"':''}>
                    <div class="col-12">
                       	<label class="item-name col-2" style="font-size: 14px;">企业网站网店：</label>
                        <input type="text" name="webSiteName" class="ipt-txt inline-txt" value="${registInfoDto.webSiteName }" size="44"/>
                       	<span style="font-size:14px;margin-left: 92px;">网址：</span>
                        <input type="text" name="webSite" class="ipt-txt inline-txt" value="${registInfoDto.webSite }" size="88"/>
                    </div>
                </div>
                <div class="form-item clearfix" ${fromtype=='batch'?'style="display:none"':''}>
                    <div class="col-12">
                       	<label class="item-name col-2" style="font-size: 14px;">企业联系人：</label>
                        <input name="linkman" type="text" class="ipt-txt inline-txt" value="${registInfoDto.linkman }" size="15"/>
                       	<span style="font-size:14px;margin-left: 295px;">手机：</span>
                        <input name="linkPhone" type="text" class="ipt-txt inline-txt" value="${registInfoDto.linkPhone }" size="36"/>
                       	<span style="font-size:14px;margin-left: 20px;">座机：</span>
                        <input name="linktel" type="text" class="ipt-txt inline-txt" value="${registInfoDto.linktel }" size="36"/>
                    </div>
                </div>
            </div>
        </div>
