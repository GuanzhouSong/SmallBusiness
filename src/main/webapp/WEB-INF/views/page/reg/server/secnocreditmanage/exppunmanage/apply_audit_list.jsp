...
<div class="form-box pd14-mr">
    <form id="searchForm" class="searchForm">
        <div class="form-list">
                ...
                <div class="col-4">
                    ...
                    <div class="col-7">
                        <div class="ipt-box col-12">
                            ...
                            <input type="text" class="ipt-txt" id="localAdmName" value="" placeholder="请选择企业管理部门" />
            ...
            <div class="form-item clearfix">
                <div class="col-4">
                    <label class="item-name col-5"><span class="long-label">列入/移出/延期文号：</span></label>
                    <div class="col-7">
                        <div class="ipt-box col-12">
            ...
            <div class="form-item clearfix">
                <div class="col-4">
                    <label class="item-name col-5"><span class="long-label">列入/移出/延期机关：</span></label>
                    <div class="col-7">
                        <div class="ipt-box col-12">
                ...
                <div class="col-4">
                    ...
                    <div class="col-7">
                        <div class="ipt-box col-575">
                            <input type="text" class="ipt-txt laydate-icon" readonly="readonly" onclick="laydate()" name="firstdateBegin" value="">
                        </div>
                        <span class="item-line col-05">-</span>
                        <div class="ipt-box col-575">
                            <input type="text" class="ipt-txt laydate-icon" readonly="readonly" onclick="laydate()" name="firstdateEnd" value="">
                        </div>
                    </div>
                </div>
                <div class="col-4">
                    ...
                    <div class="col-6">
                        <div class="ipt-box col-12">
                            <select name="regState">
                                ...
                                <option value="XX">已注销</option>
                                <option value="D">已吊销</option>
                                <option value="Q">已迁出</option>
                            </select>
                        </div>
                    </div>
                </div>
            ...
            <div class="form-item clearfix">
                <div class="col-4">
                    <label class="item-name col-5"><span class="long-label">列入/移出/延期期限：</span></label>
                    <div class="col-7">
                        <div class="ipt-box col-575">
                ...
                <div class="col-4">
                    ...
                    <div class="col-7">
                        <div class="ipt-box col-575">
                            <input type="text" class="ipt-txt laydate-icon" readonly="readonly" onclick="laydate()" name="auditDateBegin" value="">
                        </div>
                        <span class="item-line col-05">-</span>
                        <div class="ipt-box col-575">
                            <input type="text" class="ipt-txt laydate-icon" readonly="readonly" onclick="laydate()" name="auditDateEnd" value="">
                        </div>
                    </div>
                </div>
                <div class="col-4">
            ...
            <div class="form-item clearfix">
                <div class="col-4">
                    <label class="item-name col-5"><span class="long-label">列入/移出/延期日期：</span></label>
                    <div class="col-7">
                        <div class="ipt-box col-575">
                            <input type="text" class="ipt-txt laydate-icon" readonly="readonly" onclick="laydate()"
...
<div class="light-info mt5">
    <span class="light">提示：列入严违失信名单的处罚类依据仅限来自工商部门的行政处罚。“列入严违期限”指企业列入严重违法失信名单依据的相关信息在企业信用信息公示系统公示之日起10个工作日内。点击“详情”和“打印”可查看与打印企业处罚类严违名单相关资料。</span>
</div>
<div class="clearfix mb5 mt5">
    <span class="light-yellow fr mt5">查询结果：
    	待审核<span id="auditTotal"></span>条，
    	审核不通过<span id="auditNotTotal"></span>条，
    	审核通过<span id="passTotal"></span>条
   	</span>
</div>
...
<script src="/js/reg/server/secnocreditmanage/exppunmanage/apply_audit_list.js"></script>
</body>
</html>