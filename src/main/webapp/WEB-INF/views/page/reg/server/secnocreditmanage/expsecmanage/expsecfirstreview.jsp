				...
				<div class="col-4">
                    ...
                    <div class="col-7">
                        <div class="ipt-box col-12">
                            ...
                            <input type="text" class="ipt-txt clearall" id="localAdmName" value="" placeholder="请选择企业管理部门"/>
...
<!--                 <div class="col-4"> -->
<!--                     <label class="item-name col-5">延期严违期限：</label> -->
<!--                     <div class="col-7"> -->
<!--                         <div class="ipt-box"> -->
<!--                             <input type="text" class="ipt-txt laydate-icon clearall" readonly="readonly" onclick="laydate()" -->
<!--                                    name="" value=""> -->
...
<div class="clearfix mb5 mt5">
    <span class="light-yellow fr mt5">查询结果：待初审<span>${dcsNum}</span>条，初审不通过<span>${csbtgNum}</span>条，待审核<span>${dshNum}</span>条</span>
</div>
...
<script src="/js/reg/server/secnocreditmanage/expsecmanage/expsecfirstreview.js"></script>
</body>
</html>