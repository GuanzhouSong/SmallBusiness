...
<div class="clearfix mb5 mt5">
    <span class="light-yellow fr mt5">查询结果：
    	待列入<span id="applySrcTotal"></span>条，
    	待初审<span id="applyFirstTotal"></span>条，
    	待审核<span id="applyAuditTotal"></span>条，
    	逾期列入<span id="applyExpirTotal"></span>条
   	</span>
</div>
...
<script src="/js/reg/server/secnocreditmanage/exppunmanage/apply_list.js"></script>
</body>
</html>