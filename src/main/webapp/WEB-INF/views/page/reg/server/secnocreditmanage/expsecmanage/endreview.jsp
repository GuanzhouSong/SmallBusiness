...
<input type="hidden" name="regOrg" value="${expSeriousCrimeList.regOrg}" />
<table cellpadding="0" cellspacing="0" border="0" class="table-horizontal mb10">
    <tbody>
    <tr>
...
<h5 class="com-info-title left pdl10">审批意见信息 <a style="color: red">请于<fmt:formatDate value="${expSeriousCrimeList.addSecTerm}" pattern="yyy年MM月dd日"/>前列入严违失信名单</a></h5>
<table cellpadding="0" cellspacing="0" border="0" class="table-horizontal">
    <tbody>
    <tr>
        <td class="bg-gray right" width="10%">经办人</td>
        <td ><div class="ipt-box">${expSeriousCrimeList.applyMan}</div></td>
  ...
  <tr>
        ...
        <td><div class="ipt-box"> ${expSeriousCrimeList.firstName}</div></td>
        <td class="bg-gray right" width="10%">初审意见  </td>
        <td><div class="ipt-box"> ${expSeriousCrimeList.firstOpin}</div></td>
        <td class="bg-gray right" width="9%"> 初审日期  </td>
        <td><div class="ipt-box"> <fmt:formatDate value="${expSeriousCrimeList.firstdate}" pattern="yyy-MM-dd"/></div></td>
    </tr>
	  <tr>
        <td class="bg-gray right" width="10%">审核意见  </td>
        <td>
                <div class="radio-box">
                    <label for=""><input class="auditCheck" name="auditCheck" value="1" type="radio" checked >同意列入 </label>
        ...
        <td><div class="ipt-box"> <input type="text" value="<fmt:formatDate value="${date}" pattern="yyy-MM-dd"/>" name="auditDate" class="ipt-txt" readonly> </div></td>
    </tr>
    <tr>
...
<script src="/js/reg/server/secnocreditmanage/expsecmanage/endreview.js"></script>
</body>
</html>