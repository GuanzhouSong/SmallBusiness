...
<form id="content_form">
        ...
        <tr>
            ...
            <td>
                <div class="ipt-box"><input type="text" class="ipt-txt" name="expExpiredDate"
                                            value="${pubOpanoMaly.secAbnTime}"/></div>
            </td>
        </tr>
        <tr>
            <td class="bg-gray right">
    ...
    经查，该企业被列入经营异常名录届满3年仍未履行相关义务。**年*月*日，该企业因**（事由）被**工商（市场监管）局列入经营异常名录。截止**年*月*日已届满3年，仍未履行相关义务。
    以上事实有：
 	1.**年*月*日《列入经营异常名录决定书》一份；
 	2.**年*月*日浙江省企业信用信息公示平台《列入经营异常名录满3年提醒公告》一份；
            ...
            <td colspan="3">
                <div class="ipt-box yj-ipt clearfix">
                    <span class="light-dark-blue clearfix">
                        <input type="text" class="ipt-txt" value="**年*月*日《列入经营异常名录满3年提醒公告》（公示系统）"/>
                    </span>
<!--                     <span class="close-box"><i class="close-icon"></i></span> -->
                </div>
            </td>
...
<!--                     <span class="close-box"><i class="close-icon"></i></span> -->
    ...
    <h5 class="com-info-title left pdl10">经办人意见信息 <a style="color: red">请于<fmt:formatDate value="${pubOpanoMaly.termAbnTime}" pattern="yyy年MM月dd日"/>前列入严违失信名单</a></h5>
