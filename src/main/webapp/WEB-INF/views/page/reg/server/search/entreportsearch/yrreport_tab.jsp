        ...
        <div class="tab-content js-tab-content" style="text-align: center;">
            <!-- 年报公示信息 -->
                <div class="tab-panel tab-panel-show" id="gongshi">
                    <div class="tab-mt10" >
                             <iframe  src="<c:url value="/entinfo/yrpub"/>?year=${year}&priPID=${priPID}&entTypeCatg=${entTypeCatg}&currencyCn=${midBaseInfo.currencyCn}" frameborder="0" style="width: 100%;" height="2500px" ></iframe>
                    </div>
                 </div>
                ...
                <c:if test="${entTypeCatg!='16'&&entTypeCatg!='17'&&entTypeCatg!='50'}">
                    ...
                    <div class="tab-panel " id="subcapital">
                        <div class="mt10">
                            <iframe  src="<c:url value="/reg/server/yr/subcapital_server/view"/>?year=${year}&priPID=${priPID}&entType=${entType}&currencyCn=${midBaseInfo.currencyCn}" frameborder="0" style="width:100%" height="800px"  ></iframe>
                        </div>
                    </div>
