...
<form id="applyForm">
	...
	<table cellpadding="0" cellspacing="0" border="0" class="table-horizontal mb10">
	    ...
	    <tr>
	        ...
	        <td width="66%">${apply.addSecCause}</td>
	    ...
	    <tr>
	        ...
	        <td colspan="3">
	            <div class="max-height90">
	                <textarea name="addSecExplain" cols=" " rows="5" style="width:100%;box-sizing:border-box;resize:none" readonly>${apply.addSecExplain}</textarea>
	            </div>
	        </td>
	    </tr>
	    <tr>
	...
	<h5 class="com-info-title left pdl10">经办人意见信息 <a style="color: red">&emsp;请于<fmt:formatDate value="${apply.addSecTerm}" pattern="yyy年MM月dd日"/>前列入严违失信名单</a></h5>    
    <table cellpadding="0" cellspacing="0" border="0" class="table-horizontal">
        <tbody>
	        <tr>
	            <td class="bg-gray right" width="9%">经办人</td>
	            <td width="20%"><div class="ipt-box"><input type="text" class="ipt-txt" value="${apply.applyMan}" readonly /></div></td>
	            <td class="bg-gray right" width="9%">经办人意见</td>
	            <td><div class="ipt-box"><input type="text" class="ipt-txt" name="applyCheck" value="${apply.applyCheck}"  readonly /></div></td>
		    ...
		    <tr>
		        ...
		        <td><div class="ipt-box"><input type="text" class="ipt-txt" value="${apply.firstName}" readonly /></div></td>
		        <td class="bg-gray right" width="10%">初审意见</td>
		        <td><div class="ipt-box">
						<input type="text" name="firstOpin" value="${apply.firstOpin}" class="ipt-txt" readonly >
					</div></td>
...
<div class="center mt20">
    <input type="button" id="cancel" class="btn" value="返回">
</div>

<script src="/js/lib/require.js"></script>
<script src="/js/config.js"></script>
<script src="/js/reg/server/secnocreditmanage/exppunmanage/apply_view.js"></script>
</body>
</html>