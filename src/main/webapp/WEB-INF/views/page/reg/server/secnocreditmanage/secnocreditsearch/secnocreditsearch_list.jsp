            ...
            <div class="col-4">
                ...
                <div class="col-7">
                    <div class="ipt-box col-12">
                            ...
                            <input type="text" class="ipt-txt text-over clx" id="SpeCauseCN" value="" placeholder="请选择列入异常原因"/>
            ...
            <div class="col-4">
                ...
                <div class="col-7">
                    <div class="ipt-box col-12">
                            ...
                            <input type="text" class="ipt-txt clx" id="localAdmName" value="" placeholder="请选择企业管理部门"/>
...
<!--                 </div> -->
                ...
                <div class="col-7">
                    <div class="ipt-box col-12">
                        ...
                        <div class="ipt-box col-575">
                            <input type="text" class="ipt-txt laydate-icon clx" onclick="laydate();" name="addSecDateEnd">
                        </div>
                    </div>
                </div>
            </div>
