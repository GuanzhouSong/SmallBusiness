                            ...
                            <table style="border:none;">
                                <c:forEach var="pubOpanoMaly" items="${pubOpanoMalyDtos}" varStatus="vs">
                                    <tr style="border:none">
                                        ...
                                        <td style="border:0px;text-align:center;background:none">
<%--                                         ${pubOpanoMaly.regState } --%>
                                         <c:if test="${fn:indexOf('K, B, A',pubOpanoMaly.regState) != -1 || pubOpanoMaly.regState == 'X' || pubOpanoMaly.regState == 'Q' }">存续</c:if>
                                         <c:if test="${pubOpanoMaly.regState == 'C'}">撤销</c:if>
                                         <c:if test="${pubOpanoMaly.regState == 'D'|| pubOpanoMaly.regState == 'DA' }">吊销</c:if>
                                         <c:if test="${pubOpanoMaly.regState == 'QX'}">迁出</c:if>
                                         <c:if test="${pubOpanoMaly.regState == 'DX' || pubOpanoMaly.regState == 'XX' }">注销</c:if>
