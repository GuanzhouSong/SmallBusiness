...
<body class="pd10">
<form id="hx-form">
	<input type="hidden" name="markUuid" value="${markUuid }" />
...
<%-- <div class="pd10 bg-gray">
				...
				<div class="clear">
					<div class="form-item ">
						...
						<div class="col-4">
							...
							<div class="col-6">
								<div class="ipt-box" >
									<input type="text" name="auditorName" readonly="readonly" class="ipt-txt" value="${sysUser.realName}" />
								</div>
							</div>
						</div>
						...
						<div class="col-4">
							...
							<div class="col-6">
								<div class="ipt-box" >
									<input type="text" name="auditTime" readonly="readonly" class="ipt-txt" value="${nowDate}" />
								</div>
							</div>
						</div>
						...
						<div class="col-4">
							...
							<div class="col-6">
								<div class="ipt-box" >
									<input type="text" name="auditDeptName" readonly="readonly" class="ipt-txt" value="${sysUser.departMent.deptName}" />
								</div>
							</div>
						</div>
						<div class="col-4">
							...
							<div class="col-6">
								<div class="ipt-box">
									<input type="radio" name="auditState" value="2" checked="checked"> 同意 <input type="radio" name="auditState" value="3"> 不同意
								</div>
							</div>
						</div>
						<div class="col-8">
							...
							<div class="col-8">
								<div class="ipt-box">
									<input type="text" name="auditorDesc" id="auditorDesc" class="ipt-txt" maxlength="300" />
								</div>
							</div>
						</div>
					</div>
        ...
        <div class="col-8 border-box pdl15">
            ...
            <p class="center mt10 mb10">
				<button id="audit_save" type="button" class="btn mr20">保存</button>
...
<script id="viewTemplate" type="text/x-handlebars-template">
    <tr>
				...
				<tr>
                    ...
                    <td class="left"><input type="text" name="auditorName" readonly="readonly" class="ipt-txt" value="${sysUser.realName}"  style="border: 0"  /></td>
                </tr>
                 <tr>
                    <td class="right bg-gray">审核日期：</td>
                    <td class="left"><input type="text" name="auditTime" readonly="readonly" class="ipt-txt" value="${nowDate}"  style="border: 0" /></td>
                </tr>
                <tr>
                    <td class="right bg-gray">审核部门：</td>
                    <td class="left"><input type="text" name="auditDeptName" readonly="readonly" class="ipt-txt" value="${sysUser.departMent.deptName}"  style="border: 0"  /></td>
                </tr>	
				<tr>
                    <td class="right bg-gray">审核结果：</td>
                    <td class="left"><input type="radio" name="auditState" value="2" checked="checked"> 同意 <input type="radio" name="auditState" value="3"> 不同意</td>
                </tr>	
<tr>
                    <td class="right bg-gray">审核意见(限300字以内)：</td>
                    <td class="left"><div class="ipt-box">
									<input type="text" name="auditorDesc" id="auditorDesc" class="ipt-txt" maxlength="300" value="同意" />
								</div></td>
                </tr>	
...
<script src="/js/reg/server/mainmark/mainmarkaudit_edit.js"></script>
</body>
</html>
