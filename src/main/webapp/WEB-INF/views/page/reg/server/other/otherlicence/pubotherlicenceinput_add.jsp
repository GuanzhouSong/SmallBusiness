...
<div class="tabbale" data-component="tab">
                ...
                <div class="col-4">
                    ...
                    <div class="col-7">
                        <div class="ipt-box col-11">
                            ...
                            <input type="text" readonly class="ipt-txt" id="regOrgName" value="" placeholder="请选择登记机关"/>
                ...
                <div class="col-4">
                    ...
                    <div class="col-7">
                        <div class="ipt-box col-11">
                            ...
                            <input type="text" readonly class="ipt-txt" id="localAdmName" value="" placeholder="请选择管辖单位"/>
                ...
                <div class="col-4">
                    ...
                    <div class="col-7">
                        <div class="ipt-box col-11">
                            ...
                            <input type="text" readonly class="ipt-txt" id="sliceNOName" value="" placeholder="请选择责任区"/>
    ...
    <div class="light-info mt5">
        <span class="light">提示：单选某一企业后添加行政许可信息</span>
    ...
    <script src="/js/reg/server/other/otherlicence/otherlicenceinput_add_main.js"></script>
</div>
</body>
</html>
