...
<form id="applyForm">
	...
	<h5 class="com-info-title left pdl10">经办人意见信息 <a style="color: red">请于<fmt:formatDate value="${apply.addSecTerm}" pattern="yyy年MM月dd日"/>前列入严违失信名单</a></h5>    
    <table cellpadding="0" cellspacing="0" border="0" class="table-horizontal">
        <tbody>
	        <tr>
	            <td class="bg-gray right" width="9%">经办人</td>
	            <td width="20%"><div class="ipt-box"><input type="text" class="ipt-txt" value="${apply.applyMan}"/></div></td>
	            <td class="bg-gray right" width="9%">经办人意见</td>
	            <td><div class="ipt-box"><input type="text" class="ipt-txt" value="${apply.applyCheck}" /></div></td>
