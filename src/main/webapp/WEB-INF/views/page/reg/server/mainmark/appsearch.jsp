...
<div class="clearfix mb5 mt5">
    <p class="fl">
        <input id="btn_add" type="button" class="btn btn-sm mr5 js-batchregist" value="添加监管标签">
        <input id="btn_back" type="button" class="btn btn-sm mr5 js-batchregist" value="返回">
    </p>
</div>
	<div>
	...
	<script src="/js/reg/server/mainmark/appsearch.js"></script>
</body>
</html>