...
<div class="clearfix reg-company-basic reg-company-basic-yellowish">
    <div class="clearfix reg-caption">
        <div class="title clearfix">
            ...
            <c:if test="${dto.regState=='K'||dto.regState=='A'||dto.regState=='B'||dto.regState=='Q'||dto.regState=='X'}">
            ...
            <c:if test="${dto.regState=='D'||dto.regState=='DA'}"> 
                <span class="icon-rectangle red fl" style="font-size:10px;">吊销</span>
            </c:if> 
            <c:if test="${dto.regState=='QX'}"> 
				...
				<div class="clear">
					<div class="form-item ">
						...
						<div class="col-4">
							...
							<div class="col-6">
								<div class="ipt-box" >
									<input type="text" name="auditorName" readonly="readonly" class="ipt-txt" value="${mainMarkDto.auditorName}" />
								</div>
							</div>
						</div>
						...
						<div class="col-4">
							...
							<div class="col-6">
								<div class="ipt-box" >
									<input type="text" name="auditTime" readonly="readonly" class="ipt-txt" value="<fmt:formatDate value="${mainMarkDto.auditTime}" pattern="yyyy-MM-dd" />" />
								</div>
							</div>
						</div>
						...
						<div class="col-4">
							...
							<div class="col-6">
								<div class="ipt-box" >
									<input type="text" name="auditDeptName" readonly="readonly" class="ipt-txt" value="${mainMarkDto.auditDeptName}" />
								</div>
							</div>
						</div>
						...
						<div class="col-4">
							...
							<div class="col-6">
								<div class="ipt-box">
									<input type="text" name="auditDeptName" readonly="readonly" class="ipt-txt" value="<c:if test="${mainMarkDto.auditState eq '1'}">待审核</c:if><c:if test="${mainMarkDto.auditState eq '2'}">审核通过</c:if><c:if test="${mainMarkDto.auditState eq '3'}">审核不通过</c:if>" />
								</div>
							</div>
						</div>
						<div class="col-8">
							...
							<div class="col-8">
								<div class="ipt-box">
									<input type="text" name="auditorDesc" id="auditorDesc" class="ipt-txt" maxlength="300" value="${mainMarkDto.auditorDesc}" />
								</div>
							</div>
						</div>
					</div>
...
<script id="viewTemplate" type="text/x-handlebars-template">
    <tr>
				...
				<tr>
                    <td class="right bg-gray">审核人：</td>
                    <td class="left"><input type="text" name="auditorName" readonly="readonly" class="ipt-txt" value="${mainMarkDto.auditorName}"  style="border: 0"  /></td>
                </tr>
                 <tr>
                    <td class="right bg-gray">审核日期：</td>
                    <td class="left"><input type="text" name="auditTime" readonly="readonly" class="ipt-txt" value="<fmt:formatDate value="${mainMarkDto.auditTime}" pattern="yyyy-MM-dd" />"  style="border: 0" /></td>
                </tr>
                <tr>
                    <td class="right bg-gray">审核部门：</td>
                    <td class="left"><input type="text" name="auditDeptName" readonly="readonly" class="ipt-txt" value="${mainMarkDto.auditDeptName}"  style="border: 0"  /></td>
                </tr>	
				<tr>
                    <td class="right bg-gray">审核结果：</td>
                    <td class="left"><input type="text" readonly="readonly" class="ipt-txt" value="<c:if test="${mainMarkDto.auditState eq '1'}">待审核</c:if><c:if test="${mainMarkDto.auditState eq '2'}">审核通过</c:if><c:if test="${mainMarkDto.auditState eq '3'}">审核不通过</c:if>"  style="border: 0"  /></td>
                </tr>	
<tr>
                    <td class="right bg-gray">审核意见(限300字以内)：</td>
                    <td class="left"><input type="text" name="auditorDesc" id="auditorDesc" class="ipt-txt" maxlength="300" value="${mainMarkDto.auditorDesc}" style="border: 0"  /></td>
                </tr>	
