...
<div class="reg-top-header">
    <div class="new-logo">
        <img src="/img/reg/server/logo-reg.jpg" alt="">
    </div>
    ...
    <div class="pane ui-layout-center">
        <div id="page-wrapper">
            ...
            <div id="content-main" class="J_mainContent">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="<c:url value="/reg/ifrindex"/>"
            ...
            <div class="footer">
                ...
                <span class="ml40">客服 400-888-4636</span>
                <span class="ml40">技术 0571-88234769</span>
            </div>
        </div>
    </div>
