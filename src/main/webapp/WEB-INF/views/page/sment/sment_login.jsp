...
<body class="login-bg log-bg">

<div class="log-cont-bg">
    <div class="log-now">
        <a href="javascript:;" class="btn-log btn js-log-now">立即登录</a>
    </div>
    <div class="log-cont">
            ...
            <div class="user-log">
                <div>
                    <form id="login-form">
                        ...
                        <div id="errorContainer" class="ft14">登录密码不能为空</div>

                        <div class="right">
                            <input  type="button" class="btn-log btn" id="login" value="确认登录" />
...
<div class="mod-1 log-footer center">
