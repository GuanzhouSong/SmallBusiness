	...
	<div> 
		<form id="webForm">
	        ...
	        <table class="table-horizontal mb20" cellpadding="0" cellspacing="0" border="0">
		        ...
		        <tr>
		        	<td rowspan="2" class="bg-gray ft14 center" width="10%">区域类型</td>
		        ...
		        <tr>
					<td colspan="2" class="bg-gray2 ft14 center" width="10%">
						<div class="col-4">
							<label class="item-name col-3"><input type="radio" id="chk_kjdsyName" name="qylx"/>跨境电商园：</label>
							<div class="col-9">
									<div class="ipt-box">
										...
										<a id="a_kjdsyName" class="link a_kjdsyName" data-id="kjdsyName" data-pcode="KJDSY">
											<%--<span class="add-icon"><i></i></span>--%>
											<span class="add-icon-new">新增电商园</span>
										</a>
									</div>
