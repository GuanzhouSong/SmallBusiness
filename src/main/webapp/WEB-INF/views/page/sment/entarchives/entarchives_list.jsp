...
<body class="pd10">
		...
		<div class="form-list">
		  <form id="entSearchForm">
  			<div class="form-item clearfix">
				<div class="col-12">
					<label class="item-name col-2">培育库类型：</label>
					<div class="col-10">
						<div class="ipt-box ">
							 <div class="radio-box">
							    <label><input type="radio" value="" name="cultivationTypeCode" checked="checked">不限</label>
                                <label><input type="radio" value="1" name="cultivationTypeCode">初创型</label>
                                <label><input type="radio" value="2"  name="cultivationTypeCode">成长型</label>
                                <label><input type="radio" value="3" name="cultivationTypeCode">领军型</label>
                            </div>
						</div>
					</div>
				</div>
	...
	<script src="/js/sment/entarchives/entarchives_list.js"></script>
</body>
</html>