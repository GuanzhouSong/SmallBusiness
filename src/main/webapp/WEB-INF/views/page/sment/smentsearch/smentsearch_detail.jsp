                            ...
                            <c:if test="${not empty dto.entTypeCatg}">
                                ...
                                <c:if test="${fn:indexOf('12,14,34,32,22,28,24', dto.entTypeCatg)!=-1}">
                                    ...
                                    <tr>
                                        ...
                                        <td width="40%">
                                            <c:if test="${dto.regState=='K'||dto.regState=='A'||dto.regState=='B'||dto.regState=='DA'||dto.regState=='X'}">存续</c:if>
                                            <c:if test="${dto.regState=='DX' || dto.regState=='XX' }">注销</c:if>
                                            <c:if test="${dto.regState=='C'}">撤销</c:if>
                                            <c:if test="${dto.regState=='D'}">吊销</c:if>
                                            <c:if test="${dto.regState=='Q'}">迁出</c:if>
                                        </td>
                                ...
                                <c:if test="${fn:indexOf('11,21,13', dto.entTypeCatg)!=-1}">
                                    ...
                                    <tr>
                                        ...
                                        <td width="40%">
                                            <c:if test="${dto.regState=='K'||dto.regState=='A'||dto.regState=='B'||dto.regState=='DA'||dto.regState=='X'}">存续</c:if>
                                            <c:if test="${dto.regState=='XX'||dto.regState=='DX'}">注销</c:if>
                                            <c:if test="${dto.regState=='C'}">撤销</c:if>
                                            <c:if test="${dto.regState=='D'}">吊销</c:if>
                                            <c:if test="${dto.regState=='Q'}">迁出</c:if>
                                        </td>
