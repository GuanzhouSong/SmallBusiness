    ...
    <form id="taskForm" class="form-box mb5">
        <div class="form-list pdr8">
                    ...
                    <div class="col-7">
                        <div class="ipt-box col-12">
                           <select name="thrIndustry" id="thrIndustry">
                               ...
                               <option value="A">第一产业</option>
                               <option value="B,C,D,E">第二产业</option>
                               <option value="F,G,H,I,J,K,L,M,N,O,P,Q,R,S">第三产业</option>
                           </select>
                        </div>
                    </div>
                </div>           
                <div class="col-4">
                    <label class="item-name col-5">企业大类型：</label>
                    <div class="col-7">
                        <div class="ipt-box col-12">
            ...
            <div class="form-item clearfix">
            	...
            	<div class="col-4">
	                    <label class="item-name col-5">企业细分类型：</label>
	                    <div class="col-7">
	                        <div class="ipt-box col-12">
...
<div class="designator-con  form-box" style="padding: 20px; margin-bottom: 20px;" >
    ...
    <div style="display: none;">
        ...
        <label><input type="checkbox" class="zbxchoose zbxchoose-Special"  name="zbxchoose" value="2" checked="checked">三次产业</label>
        ...
        <label><input type="checkbox" class="zbxchoose zbxchoose-Special"  name="zbxchoose" value="5" checked="checked" >企业分类</label>
        <label><input type="checkbox" class="zbxchoose zbxchoose-Special"  name="zbxchoose" value="6" checked="checked" >登记机关</label>
     </div>
        ...
        <ul class="clearfix">
            <li>
                <label><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="7"></span></span>已年报企业</label>
            </li>
            <li>
                <label><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value=8"></span></span>年报率</label>
            </li>
            <li>
                <label><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="9"></span></span>开业数</label>
            </li>
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="10" ></span></span>开业率</label>
            </li>
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="11"></span></span>营业收入总额</label>
            </li>
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="12"></span></span>资产总额</label>
            </li>
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="13"></span></span>固定资产总额</label>
            </li>
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="14"></span></span>负债总额</label>
            </li>
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="15"></span></span>资产负债率</label>
            </li>
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="16"></span></span>利润总额</label>
            </li>
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="17"></span></span>净利润</label>
            </li>
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="18"></span></span>盈利企业数</label>
            </li>
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="19"></span></span>亏损企业数</label>
            </li>
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="20"></span></span>纳税总额</label>
            </li>
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="21"></span></span>从业人数</label>
            </li>
        </ul>
    ...
    <div class="center mt10">
        <a href="javascript:void(0)" class="btn mr20" id="save">保存</a>
...
<script src="/js/sment/rpt/rptyrsmnormal_list.js"></script>
</body>
</html>
