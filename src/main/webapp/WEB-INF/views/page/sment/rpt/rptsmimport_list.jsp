    ...
    <form id="taskForm" class="form-box mb5">
        <div class="form-list pdr8">
            <div class="form-item clearfix">
                ...
                <div class="col-4">
                    <label class="item-name col-5">企业负责人年龄：</label>
                    <div class="col-7">
                        <div class="ipt-box col-12">
            ...
            <div class="form-item clearfix">
                <div class="col-4">
                    ...
                    <div class="col-7">
                        <div class="ipt-box col-12">
                           <select name="eigIndustry" id="eigIndustry">
                               <option value="">请选择</option>
                               <option value="eigIndustry1">信息经济产业</option>
                               <option value="eigIndustry2">环保产业</option>
                               <option value="eigIndustry3">旅游产业</option>
                               <option value="eigIndustry4">金融产业</option>
                               <option value="eigIndustry5">健康产业</option>
                               <option value="eigIndustry6">时尚产业</option>
                               <option value="eigIndustry7">高端装备制造产业</option>
                               <option value="eigIndustry8">文化创意产业</option>
                           </select>
                        </div>
                    </div>
                </div>           
            ...
            <div class="form-item clearfix">          
            	<div class="col-4">
	                    <label class="item-name col-5">企业分类：</label>
	                    <div class="col-7">
	                        <div class="ipt-box col-12">
...
<div class="designator-con form-box" style="padding: 20px; margin-bottom: 20px;" >
    ...
    <div style="display: none;">
        ...
        <label><input type="checkbox" class="zbxchoose zbxchoose-Special"  name="zbxchoose" value="1" checked="checked" >时间区间</label>
        <label><input type="checkbox" class="zbxchoose zbxchoose-Special"  name="zbxchoose" value="2" checked="checked">八大重点产业</label>
        <label><input type="checkbox" class="zbxchoose zbxchoose-Special"  name="zbxchoose" value="3" checked="checked" >企业大类</label>
        <label><input type="checkbox" class="zbxchoose zbxchoose-Special"  name="zbxchoose" value="4" checked="checked" >企业分类</label>
        <label><input type="checkbox" class="zbxchoose zbxchoose-Special"  name="zbxchoose" value="5" checked="checked" >登记机关</label>
     </div>
        ...
        <ul class="clearfix">
            <li>
                <label><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="6"></span></span>在册企业数</label>
            </li>
            <li>
                <label><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="7"></span></span>新设企业数</label>
            </li>
            <li>
                <label><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="8"></span></span>注销企业数</label>
            </li>
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="9" ></span></span>在册小微企业数</label>
            </li>
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="10" ></span></span>新设小微企业数</label>
            </li>
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="11" ></span></span>注销小微企业数</label>
            </li>
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="12"></span></span>在册小微企业注册资本总额</label>
            </li>
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="13"></span></span>新设小微企业注册资本总额</label>
            </li>
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="14"></span></span>新设小微企业平均注册资本</label>
            </li>
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="15"></span></span>新设小微企业负责人平均年龄</label>
            </li>
<!--             <li> -->
<!--                 <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="14"></span></span>负责人80后的新设小微企业数</label> -->
<!--             </li> -->
<!--             <li> -->
<!--                 <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="15"></span></span>负责人90后的新设小微企业数</label> -->
            </li>
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="16"></span></span>负责人是省内的新设小微企业数</label>
            </li>
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="17"></span></span>股东全为自然人的新设小微企业数</label>
            </li>
        </ul>
...
<script>
    window._CONFIG = {
        ...
        chooseUrl:'${deptCode == 3300 ? "rptSmImportsjCount.json" : "rptSmImportCount.json"}'
    }
</script>
<script src="/js/lib/require.js"></script>
<script src="/js/config.js"></script>
<script src="/js/sment/rpt/rptsmimport_list.js"></script>
</body>
</html>
