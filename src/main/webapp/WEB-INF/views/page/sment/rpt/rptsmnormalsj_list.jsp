...
<div class="designator-con form-box" style="padding: 20px; margin-bottom: 20px;" >
    ...
    <div style="display: none;">
        ...
        <label><input type="checkbox" class="zbxchoose"  name="zbxchoose" value="5" checked="checked" >企业分类</label>
        <label><input type="checkbox" class="zbxchoose"  name="zbxchoose" value="6" checked="checked" >登记机关</label>
     </div>
        ...
        <ul class="clearfix">
            <li>
                <label><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="7"></span></span>在册企业数</label>
            </li>
            <li>
                <label><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="8"></span></span>新设企业数</label>
            </li>
            <li>
                <label><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="9"></span></span>注销企业数</label>
            </li>
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="10"></span></span>在册小微企业数</label>
            </li>
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="11" ></span></span>新设小微企业数</label>
            </li>
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="12" ></span></span>注销小微企业数</label>
            </li>
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="13"></span></span>在册小微企业注册资本总额</label>
            </li>
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="14"></span></span>新设小微企业注册资本总额</label>
            </li>
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="15"></span></span>新设小微企业平均注册资本</label>
            </li>
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="16"></span></span>新设小微企业负责人平均年龄</label>
            </li>
<!--             <li> -->
...
<!--             </li> -->
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="17"></span></span>负责人是省内的新设小微企业数</label>
            </li>
            <li>
                <label style="display: none;" class="choose-n"><span class="mr5"><input type="checkbox" class="zbxchoose zbxchoose-ususal" name="zbxchoose" checked  value="18"></span></span>股东全为自然人的新设小微企业数</label>
            </li>
        </ul>
...
<script src="/js/sment/rpt/rptsmnormalsj_list.js"></script>
</body>
</html>
