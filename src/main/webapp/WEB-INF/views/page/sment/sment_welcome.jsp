        ...
        <div class="m-zj-todo clearfix">
            <div class="u-todo u-todo-l" style="width:48%">
                ...
                <ul>
                    ...
                    <li><a href="javascript:void(0);" class="h-explain fastLink" data-idx='2'><i>● </i>待更新需求 <span>[<span
                            id="span_help_1">0</span>]</span></a></li>
                    <li><a href="javascript:void(0);" class="h-explain fastLink" data-idx='2'><i>● </i>待帮扶 <span>[<span
            ...
            <div class="u-todo u-todo-r" style="width:52%">
                ...
                <ul>
                    <li><a href="javascript:void(0);" class="h-explain fastLink" data-idx='3'><i>● </i>入库企业注销 <span>[<span
                            id="span_rkqyzx">0</span>]</span></a></li>
                    <li><a href="javascript:void(0);" class="h-explain fastLink" data-idx='3'><i>● </i>入库企业上规升级 <span>[<span
                            id="span_sgsj">0</span>]</span></a></li>
                    <li><a href="javascript:void(0);" class="h-explain fastLink" data-idx='3'><i>● </i>入库企业营收下降 <span>[<span
                            id="span_ysxj">0</span>]</span></a></li>
                    <li><a href="javascript:void(0);" class="h-explain fastLink" data-idx='3'><i>● </i>入库企业经营异常 <span>[<span
                            id="span_jyyc">0</span>]</span></a></li>
                    <li><a href="javascript:void(0);" class="h-explain fastLink" data-idx='3'><i>● </i>入库企业违法违规 <span>[<span
    ...
    <div class="m-chart-con mb20 clearfix">
        ...
        <div class="u-con-msg">
            <div class="u-brt">
                ...
                <span>八大万亿产业小微企业总数：<i id="js_bdwycount">0</i> 户</span>
            </div>
            <div class="u-brt">
                <span>规上、限上企业户数：<i id="js_entAboveCount">0</i> 户</span>
                <span>动产抵押企业：<i id="js_dcdyCount">0</i> 户</span>
                <span>国家商标：<i id="js_gjsbCount">0</i> 个</span>
            </div>
            <div class="u-brt">
                <span>盈利企业数：<i id="js_addProCount">5609843</i> 户</span>
                <span>纳税总额：<i id="js_ratGro">334858378</i> 万元</span>
                <span>从业人数：<i id="js_empNum">768921</i> 人</span>
            </div>
        </div>
...
<div class="type-box mb20">
    <h3 class="type-hd">培育库企业</h3>
    <div class="clearfix">
        <div class="fl pie-charts">
            <h4 class="type-title">完成培育动态统计</h4>
        ...
        <div class="fl zxt-charts">
            <h4 class="type-title">培育库企业成长轨迹</h4>
