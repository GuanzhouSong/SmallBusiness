...
<body class="pd10">
	...
	<input type="hidden" id="num" value="${num }">
     ...
     <div class="tzs-content">
         ...
         <p class="tindent24">联系人：<input type="text" name="contactName" class="ipt-txt2 w120 mr40" readonly="readonly" value="${realName }">联系电话：<input name="contactTel" type="text" class="ipt-txt2 w120" readonly="readonly" value="${phone }"></p>
         <div class="tzs-time fr">
             <p class="tr"><input type="text" class="ipt-txt2" name="deptment" readonly="readonly" value="${deptName }">（公章）</p>
