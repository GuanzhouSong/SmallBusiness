...
<div class="tabbale" data-component="tab">
                    ...
                    <div class="col-7">
                        <div class="ipt-box col-11">
                            <select id="regState" name="regState">
                                <option value="">全部</option>
                                <c:forEach var="regState" items="${regStateList}"  varStatus="status">
                                	<option value='${regState.regState}'}>${regState.csStateDesc}</option>
                            	</c:forEach>
                            </select>
                        </div>
                    </div>
    ...
    <script src="/js/syn/system/search/punishsearch/punishsearch.js"></script>
</div>
</body>
</html>
