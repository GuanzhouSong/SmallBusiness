                ...
                <div class="tab-panel tab-panel-show">
                    <div class="">
                        <div class="print-nocard">
                            ...
                            <input type="hidden" id="feedBack" value="${info.feedBack}"/>
                            ...
                            <div class="bg-gray3">
                                <table border="0" cellspacing="0" cellpadding="0" class="table-form mt30">
                                    ...
                                    <tr>
                                        ...
                                        <td width="40%">
                                            <div class="ipt-box">
                                                <select>
                                                    <option value="${info.punField}"
                                                            selected="selected">${info.punField}</option>
                                                </select>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="ipt-box col-5">
                                                <span><fmt:formatDate value="${info.legDate}"
                                    ...
                                    <tr>
                                        ...
                                        <td class="pd0"><span class="item-txt">从</span>
                                            ...
                                            <div class="radio-box">
                                                <input type="checkbox" class="ml15" name="isLife" value="1"
                                                       <c:if test="${info.isLife=='1'}">checked="checked"</c:if>
                                                       disabled>终身
                                            </div>
                                        </td>
                                    </tr>
                                                    ...
                                                    <c:forEach items="${details}" var="obj">
                                                        <tr>
                                                            ...
                                                            <c:if test="${obj.record== '有'}">
                                                                <td value="有"><a href='javascript:void(0)' tag='view'
                                                                                 priPID='${obj.priPID}'>有/查看</a></td>
                                                            </c:if>
                                        ...
                                        <td colspan="3" class="pd1">
                                            <div id="filelabel">
                                                <c:forEach items="${files}" var="obj">
                                                    <a path="${obj}" href="javascript:void(0)" title="点击下载"><i
                                                            class="xbt-icon file-icon"></i>${fn:substringAfter(obj, '-')}
                                                    </a><br>
                                                </c:forEach>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="radio-box">
                                                <label><input type="radio" class="feedBack" value="1"
                                                              <c:if test="${info.feedBack == '1'}">checked="checked"</c:if>
                                                              disabled>是</label>
                                                <label><input type="radio" class="feedBack" value="0"
                                                              <c:if test="${info.feedBack == '0'}">checked="checked"</c:if>
                                                              disabled>否</label>
                                            </div>
                                        </td>
                                    </tr>
                                ...
                                <table border="0" cellspacing="0" cellpadding="0" class="table-form mt10">
                                    <tbody>
                                    <tr>
                                        <td class="tb-form-hd" width="12%"><span style="color: red"> *</span>审核结果</td>
                                        <td width="34%">
                                            <div class="radio-box">
                                                <label><input type="radio" name="auditRes" value="0"
                                                              <c:if test="${info.auditRes == '0'}">checked="checked"</c:if>>同意发出</label>
                                                <label><input type="radio" name="auditRes" value="1"
                                                              <c:if test="${info.auditRes == '1'}">checked="checked"</c:if>>不同意发出</label>
                                                <label><input type="radio" name="auditRes" value="2"
                                        ...
                                        <td>
                                            <c:if test="${info.auditTime !=null}">
                                                <fmt:formatDate value="${info.auditTime}" pattern="yyyy-MM-dd"/>
                                            </c:if>
                                            <c:if test="${info.auditTime ==null}">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="5" class="pd3">
                                            <div><textarea id="auditView" name="auditView" cols=" " rows="5"
                                                           maxlength="200"
                                                           placeholder="200字以内">${info.auditView}</textarea></div>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
                        ...
                        <p class="center mt20"><input type="button" class="btn mr20" value="打 印" id="print"><input
                                type="button" id="audit" class="btn mr20" value="审核确认"><input type="button" id="cancel"
                                                                                              class="btn mr20"
                                                                                              value="返回"></p>
                    </div>
                </div>
