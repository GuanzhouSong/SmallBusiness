...
<div class="tabbale" data-component="tab">
    ...
    <form id="searchForm" class="form-box mb5">
         ...
         <div class="form-list">
             ...
             <div class="form-item clearfix">
                 <div id="uniCode" class="col-4">
                     <label class="item-name col-5">惩戒当事人：</label>
                     <div class="col-6">
                         <div class="ipt-box col-12">
                             <input type="text" class="ipt-txt" name="litiName" value="" placeholder="惩戒当事人姓名" />
                         </div>
                     </div>
                 </div>
                 <div class="col-4" id="entName">
                     <label class="item-name col-5">惩戒当事人证件号：</label>
                     <div class="col-6">
                         <div class="ipt-box col-12">
                             <input type="text" class="ipt-txt" name="cardNo" value="" placeholder="请输入当事人证件号" />
                         </div>
                     </div>
                 </div>
                 <div class="col-4">
     ...
     <div class="tab-content mb20">
           ...
           <div class="">
			<div class="table-out">
			    <table id="man_table" border="0" cellspacing="0" cellpadding="0" class="table-row perc-100 nowrap">
			        <thead>
			        <tr>
			            <th >序号</th>
			            <th >操作</th>
...
<script src="/js/syn/system/nocreditPunish/info/list_man.js"></script>
