...
<body class="pd10">
<form id="qryForm">
	<input type="hidden" value="${groupUid }" id="groupUid">
...
<div class="clearfix mb5">
    <span class="light">提示：失效人员不纳入检查执法人员抽取范围。</span>
</div>
<div>
...
<script src="/js/syn/system/sccheck/scentagent/scagentrandom_list.js"></script>
</html>