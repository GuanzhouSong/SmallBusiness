...
<h6 class="h6-title mt20 mb5 light-yellow">第二步：添加企业关注服务对象标识</h6>
<div class="clearfix mb5">
    <p class="fl">
        <input type="button" class="btn btn-sm mr5" id="cancel" value="返回"><input
            type="button" class="btn btn-sm" id="enaddmark" value="增加关注标识"><span
            class="ml20">您已经选中了<span id="entNum"></span>家企业</span>
    </p>
</div>
<div style="padding-bottom: 50px;">
    <table border="0" cellspacing="0" cellpadding="0"
           class="table-row perc-100 mt30">
        <thead>
        <tr>
            ...
            <th style="text-align: center;width: 80px;">历史关注记录</th>
        </tr>
        </thead>
        <tbody id="enttbody">
        </tbody>
...
<script src="/js/syn/system/concern/conc/con_apply_add.js"></script>
</body>
</html>