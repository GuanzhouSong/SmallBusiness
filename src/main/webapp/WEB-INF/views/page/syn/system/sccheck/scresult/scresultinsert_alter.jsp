                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="100%" class="table-horizontal table-form">
	                       ...
	                       <table cellpadding="0" cellspacing="0" border="0" width="100%" class="table-horizontal table-form">
	                            ...
	                            <tr>
	                                ...
	                                <td width="40%"><input class="crt" type="checkbox" value="1" name="checkResultTmp" width="40%"
	                                ...
	                                <td width="45%"><input class="crt" type="checkbox" value="6" name="checkResultTmp" width="40%"
	                                	<c:forEach items="${str1 }" var="it">
