                            ...
                            <c:if test="${not empty dto.entTypeCatg}">
                                ...
                                <c:if test="${fn:indexOf('12,14,34,32,22,28,24', dto.entTypeCatg)!=-1}">
                                    ...
                                    <tr>
                                        ...
                                        <td width="40%">
                                            <c:if test="${dto.regState=='K'||dto.regState=='A'||dto.regState=='B'||dto.regState=='Q'||dto.regState=='X'}">存续</c:if>
                                            <c:if test="${dto.regState=='DX' || dto.regState=='XX' }">注销</c:if>
                                            <c:if test="${dto.regState=='C'}">撤销</c:if>
                                            <c:if test="${dto.regState=='D' || dto.regState=='DA'}">吊销</c:if>
                                            <c:if test="${dto.regState=='QX'}">迁出</c:if>
                                        </td>
