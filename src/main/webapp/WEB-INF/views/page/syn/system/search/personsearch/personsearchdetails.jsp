...
<body>
	<form action="" id="hx-form">
		<input id="cerNO" type="hidden" name="cerNO" value="${dto.cerNO}"> <input type="hidden" id="regState" name="regState" value="'K','B','A','DA','X'">
	</form>
	<div class="pd20">
					...
					<div class="tab-panel tab-panel-show" id="tab_tzrzqk">
						<div class="">
							...
							<!-- <h5 class="com-info-title mt10">
								<div class="col-1">
									<div class="ipt-box col-12">
										<select id="tzqyxxRegState" name="tzqyxxRegState" class="clx">
											<option value="">登记状态</option>
											<option value="'K','B','A','DA','X'" selected="selected">存续</option>
											<option value="'D'">吊销</option>
											<option value="'C'">撤销</option>
											<option value="'XX'">撤销</option>
										</select>
									</div>
								</div>
								投资企业信息 <span class="fr">数据来源：工商部门和企业年报</span>
							</h5> -->
							<div class="clearfix sel-title-box">
