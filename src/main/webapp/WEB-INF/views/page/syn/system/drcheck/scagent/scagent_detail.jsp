            ...
            <tr>
                ...
                <td colspan="5">
                    <div class="ipt-box pd0" id="stationTermDiv">
                        ...
                        <input type="checkbox" value="1" id="stationTermM1" class="stationTermM" ${fn:indexOf(pubScagent.stationTerm,'1')!=-1?'checked':''} disabled="disabled"/>保化检查员
                        <input type="checkbox" value="2" id="stationTermM2" class="stationTermM" ${fn:indexOf(pubScagent.stationTerm,'2')!=-1?'checked':''} disabled="disabled"/>药品检查员
                        <input type="checkbox" value="3" id="stationTermM3" class="stationTermM" ${fn:indexOf(pubScagent.stationTerm,'3')!=-1?'checked':''} disabled="disabled"/>医疗器械检查员
                        <input type="checkbox" value="4" id="stationTermM4" class="stationTermM" ${fn:indexOf(pubScagent.stationTerm,'4')!=-1?'checked':''} disabled="disabled"/>特种设备安全监员
                        <span style="color: blue;">)</span>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="5">
                    <div class="ipt-box pd0" id="expertFlagDiv">
                        ...
                        <span style="color: blue;">(</span>
                        <input type="checkbox" value="1" id="expertFlagM1" class="expertFlagK" ${fn:indexOf(pubScagent.expertFlag,'1')!=-1?'checked':''} disabled="disabled"/>保化组长
                        <input type="checkbox" value="2" id="expertFlagM2" class="expertFlagK" ${fn:indexOf(pubScagent.expertFlag,'2')!=-1?'checked':''} disabled="disabled"/>药品GSP
                        <input type="checkbox" value="3" id="expertFlagM3" class="expertFlagK" ${fn:indexOf(pubScagent.expertFlag,'3')!=-1?'checked':''} disabled="disabled"/>药品GMP
                        <input type="checkbox" value="4" id="expertFlagM4" class="expertFlagK" ${fn:indexOf(pubScagent.expertFlag,'4')!=-1?'checked':''} disabled="disabled"/>医疗器械GSP
                        <input type="checkbox" value="5" id="expertFlagM5" class="expertFlagK" ${fn:indexOf(pubScagent.expertFlag,'5')!=-1?'checked':''} disabled="disabled"/>医疗器械GMP
                        <span style="color: blue;">)</span>
                    </div>
                </td>
            </tr>
