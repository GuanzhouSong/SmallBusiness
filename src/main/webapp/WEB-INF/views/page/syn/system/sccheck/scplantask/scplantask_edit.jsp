        ...
        <form id="favorableForm">
        	...
        	<table id="savetable" cellpadding="0" cellspacing="0" border="0" width="100%" class="table-horizontal mt10">
	           ...
	           <tr>
	            ...
	            <tr>
	               <td class="bg-gray right"><span style="color:red;">*</span>抽查方式:</td>
	                  <td>
		                <div id="licZoneDiv" class="ipt-box pd0">
			                 <label><input type="radio" name="taskType" ${pubScPlanTask.taskType=='1'?'checked':''}   value="1" >定向  &nbsp;</label>
			                 <label><input type="radio" name="taskType" ${pubScPlanTask.taskType=='2'?'checked':''} value="2" >不定向  &nbsp;</label>
			            </div>
	                </td>
	            ...
	            <tr>
	               <td class="bg-gray right"><span style="color:red;">*</span>任务实施部门:</td>
	                  <td colspan="3">
		                <div class="ipt-box pd0">
	            ...
	            <tr>
	               <td class="bg-gray right">任务内容：</td>
	               <td colspan="3">
		                <div class="ipt-box pd0">
