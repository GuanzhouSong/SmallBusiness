...
<!--                         <span class="add-icon" id="unitChoose"><i></i></span> -->
            ...
            <tr>
             ...
             <tr>
                ...
                <td class="bg-gray right" width="15%">
<!--                 <span class="light">*</span>岗位管辖片区： -->
                </td>
                <td colspan="3" width="40%">
                    <div class="ipt-box pd0">
                    	<input type="hidden" name="deptCode" id="deptCode" value="${sessionDeptCode}" style="display: none;"/>
                        <input type="text" id="deptCodeName"  class="ipt-txt" value="${deptName}" placeholder="请选择部门（机构）" disabled="disabled" style="display: none;"/>
                    </div>
                </td>
            </tr>
            <tr>
