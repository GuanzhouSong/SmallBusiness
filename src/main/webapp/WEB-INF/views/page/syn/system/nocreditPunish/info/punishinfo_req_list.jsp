...
<div class="tabbale" data-component="tab">
    ...
    <form id="searchForm" class="form-box mb5">
        ...
        <div class="form-list">
            <div class="form-item clearfix">
                ...
                <div class="col-4">
                    <label class="item-name col-6">惩戒当事人证件号：</label>
                    <div class="col-6">
                        <div class="ipt-box col-12">
            ...
            <div class="form-item clearfix">
                <div class="col-4" id="litiName">
                    <label class="item-name col-6">惩戒当事人姓名：</label>
                    <div class="col-6">
                        <div class="ipt-box col-12">
                            <input type="text" class="ipt-txt" name="litiName" value="" placeholder="请输入当事人姓名"/>
                        </div>
                    </div>
                </div>
                <div class="col-4">
                    <label class="item-name col-6">惩戒提请部门：</label>
                    <div class="col-6">
                        <div class="ipt-box col-12">
            ...
            <div class="form-item clearfix">
                ...
                <div class="col-4" id="feedBack">
                    <label class="item-name col-6">是否需要反馈：</label>
                    <div class="col-6">
                        <div class="ipt-box col-12">
            ...
            <div class="form-item clearfix mb10">
                <div class="col-4">
                    <label class="item-name col-6">惩戒单类型：</label>
                    <div class="col-6">
                        <div class="ipt-box col-12">
    ...
    <div class="clearfix mb5">
        <p class="fl"><input type="button" id="add" class="btn btn-sm mr5" value="添加惩戒记录"></p>
    </div>
...
<script src="/js/syn/system/nocreditPunish/info/list_req.js"></script>
