...
<body class="pd10">
           ...
           <input type="hidden" name="checkResult" id="checkResult">
               ...
               <div class="form-item clearfix">
                 ...
                 <div class="col-4">
                    ...
                    <div class="col-7">
                        <div class="ipt-box col-11">
                            <input  class="ipt-txt" name="checkDeptName" id="checkDeptName" value=""/>
                        </div>
                    </div>
                 </div>
                 <div class="col-4">
 ...
 <div class="light-info mb5 mt5">
    <span class="light"><input type="button" id="js-appoint" value="指派抽查机关" class="btn">提示：对已抽取过执法人员的检查名单由被指派的抽查机关负责对该检查名单调整相应的检查人员。</span>
 </div>
<div> 
