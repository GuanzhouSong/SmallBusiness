...
<div class="light-info">
    <span class="light">提示：1. 勾选涉证企业可批量予以审批认领或抄告接收。2. 明确为错误推送的涉证企业可点击认领中的“回退”后予以重新推送。3. 涉证企业处理时限：超过10个工作日未处理的显示<i
...
<script src="/js/syn/system/pubdtinfo/pubdtinforeceive_list.js"></script>
</body>
</html>
