                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="100%" class="table-horizontal table-form">
	                       ...
	                       <table id="table2" cellpadding="0" cellspacing="0" border="0" width="100%" class="table-horizontal table-form">
	                            ...
	                            <tr>
	                                ...
	                                <td class="bg-gray center" width="35%"><span class="light">*</span>发现问题情况</td>
	                                <td class="bg-gray center" width="35%"><span class="light">*</span>处置情况</td>
	                            </tr>
	                            <c:forEach var="pubSccheckItemResult1" items="${pubSccheckItemResultList }" varStatus="status">
		                            <tr>
		                                <td>${status.index+1}. ${pubSccheckItemResult1.checkName }<input type="hidden" name="checkName_${pubSccheckItemResult1.checkCode }" value="${pubSccheckItemResult1.checkName }"></td>
		                                <td class="center">
	                       ...
	                       <table cellpadding="0" cellspacing="0" border="0" width="100%" class="table-horizontal table-form">
	                       	  <tbody>
	                            <tr>
	                                <td width="15%" class="bg-gray center"><span class="light">*</span>核查方式</td>
	                            ...
	                            <tr>
	                                ...
	                                <td><input class="crt" type="checkbox" value="1" name="checkResultTmp" width="40%"
	                                ...
	                                <td><input class="crt" type="checkbox" value="6" name="checkResultTmp" width="40%"
	                                	<c:forEach items="${str1 }" var="it">
	                            ...
	                            <tr>
	                                <td><input class="crt" type="checkbox" value="2" name="checkResultTmp"
	                                	<c:forEach items="${str1 }" var="it">
	                            ...
	                            <tr>
	                                <td><input class="crt" type="checkbox" value="3" name="checkResultTmp"
	                                	<c:forEach items="${str1 }" var="it">
	                            ...
	                            <tr>
	                                <td><input class="crt" type="checkbox" value="4" name="checkResultTmp"
	                                	<c:forEach items="${str1 }" var="it">
	                            ...
	                            <tr>
	                                <td colspan="2"><input class="crt" type="checkbox" value="5" name="checkResultTmp"
	                            ...
	                            <tr>
	                                ...
	                                <td colspan="2">
	                                	<input class="disaf" type="checkbox" name="disposeMssTmp" value="无须后置处置措施；"
	                                		<c:if test="${fn:indexOf(pubScentResultDto.disposeMss, '无须后置处置措施；')!=-1}">checked</c:if>
	                                	>无须后置处置措施；<br>
	                                	...
	                                	<input class="disaf" type="checkbox" name="disposeMssTmp" value="违反本部门相关规定，责令限期整改；后续跟踪由日常监管部门负责；"
	                                		<c:if test="${fn:indexOf(pubScentResultDto.disposeMss, '违反本部门相关规定，责令限期整改；后续跟踪由日常监管部门负责；')!=-1}">checked</c:if>
	                                	>违反本部门相关规定，责令限期整改；后续跟踪由日常监管部门负责；<br>
	                                	...
	                                	<input class="disaf" type="checkbox" name="disposeMssTmp" value="other"
	                                		<c:forEach items="${str2 }" var="it" varStatus="stat">
	                                			<c:if test="${stat.last}">
	                                				...
	                                				&&it!='违反本部门相关规定，责令限期整改；后续跟踪由日常监管部门负责；'&&it!='停止检查，反馈至日常监管部门依法依规处理；'
	                                				&&it!='无须后置处置措施；'
	                                				}">
	                                					checked
...
<!-- 	                       			<a href="javascript:void(0);" id="addAgent">添加</a> -->
	                       		...
	                       		<tr>
	                       			...
	                       			<td><input type="radio" class="pa" name="auditState" value="5">通过
	                       			   <input type="radio" class="pa" name="auditState" value="4">不通过</td>
	                       		...
	                       		<tr>
	                       			...
	                       			<td><input type="text" readonly="readonly" id="auditOpinion" name="auditOpinion"></td>
	                       			<td class="bg-gray right">审核日期</td>
	                       			<td><input name="auditDate" type="text" class="ipt-txt laydate-icon" onclick="laydate()" readonly="readonly" value="<fmt:formatDate value='${now }' pattern='yyyy-MM-dd'/>"/></td>
	                       		</tr>
	                       </table>
                    </div>
                    </form>
...
<script src="/js/syn/system/sccheck/scresult/scresultaudit_edit.js"></script>
</body>
</html>