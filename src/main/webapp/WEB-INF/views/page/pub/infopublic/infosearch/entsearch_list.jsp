        ...
        <c:if test="${not empty entBasicInfos}">
 		<c:forEach items="${entBasicInfos.content}" var="ppBasicInfo" varStatus="status">
            ...
            <li>
                ...
                <span>${ppBasicInfo.entName }
                </span>
                <c:if test="${ppBasicInfo.regState=='K'||ppBasicInfo.regState=='B'||ppBasicInfo.regState=='A'||ppBasicInfo.regState=='DA'||ppBasicInfo.regState=='X'||ppBasicInfo.regState=='Q'}">
                <i class="icon-rectangle icon-blue">存续</i><span class="tip">
                </c:if>
                <c:if test="${ppBasicInfo.regState=='XX'||ppBasicInfo.regState=='DX'}">
                <i class="icon-rectangle icon-gray">注销</i><span class="tip">
                </c:if>
                <c:if test="${ppBasicInfo.regState=='QX'}">
                <i class="icon-rectangle1 icon-gray">迁出</i><span class="tip">
                </c:if>
                <c:if test="${ppBasicInfo.regState=='C'}">
                <i class="icon-rectangle icon-gray">撤销</i><span class="tip">
                </c:if>
                <c:if test="${ppBasicInfo.regState=='D'}">
                <i class="icon-rectangle icon-red">吊销</i><span class="tip">
                </c:if>
