            ...
            <ul class="encounter-info clearfix">
                ...
                <c:if test="${fn:indexOf('12,14,34,32,22,28,24', entBasicInfo.entTypeCatg)!=-1}">
                    ...
                    <li>
	                    ...
	                    <span>
							<c:if test="${entBasicInfo.regState=='K'||entBasicInfo.regState=='B'||entBasicInfo.regState=='A'||entBasicInfo.regState=='DA'||entBasicInfo.regState=='X'||entBasicInfo.regState=='Q'}">
                                存续</i>
                            </c:if>
