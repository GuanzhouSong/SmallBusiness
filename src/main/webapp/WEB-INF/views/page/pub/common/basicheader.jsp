...
<div class="mod company-basic clearfix">
    <div class="caption">
        <div class="title clearfix">
            ...
            <c:if test="${entBasicInfo.regState=='K'||entBasicInfo.regState=='A'||entBasicInfo.regState=='B'||entBasicInfo.regState=='DA'||entBasicInfo.regState=='X'||entBasicInfo.regState=='Q'}">
            ...
            <c:if test="${entBasicInfo.regState=='QX'}">
                <span class="icon-rectangle1 icon-gray fl">迁出</span>
            </c:if>
    ...
    <div class="tab-header tab-detail">
        <ul class="clearfix">
            ...
            <c:if test="${entBasicInfo.entTypeCatg != '16' && entBasicInfo.entTypeCatg != '17' && entBasicInfo.entTypeCatg != '50'}">
                ...
                ><a class="tab-item"
                    href="../../entinfo/illegalinfo?encryPriPID=${entBasicInfo.encryPriPID }&classFlag=${classFlag}">列入严重违法失信企业名单（黑名单）信息</a>
                </li>
            </c:if>
        </ul>
    </div>
