require(['component/iframeLayer', 'component/dataTable', 'common/util', 'common/http', 'handlebars', 'jquery','jquery.serialize','laydate','jquery.validate','jquery.multiselect'], function (layer, dataTable, util, http,handlebars) {
    ...
    function bind() {
        util.bindEvents([{
        	...
        	handler: function () {
        		if($(this).prop("checked")){
        			$("#stationTermM1").prop("checked",false);
        			$("#stationTermM2").prop("checked",false);
        			$("#stationTermM3").prop("checked",false);
        			$("#stationTermM4").prop("checked",false);
        			$("#stationTermM1").attr("disabled","disabled");
        			$("#stationTermM2").attr("disabled","disabled");
        			$("#stationTermM3").attr("disabled","disabled");
        			$("#stationTermM4").attr("disabled","disabled");
        		}
        	}
        },{
        	el: '#stationTermM',
        	...
        	handler: function () {
        		if($(this).prop("checked")){
        			$("#stationTermM1").removeAttr("disabled");
        			$("#stationTermM2").removeAttr("disabled");
        			$("#stationTermM3").removeAttr("disabled");
        			$("#stationTermM4").removeAttr("disabled");
        		}
        	}
        },{
        	el: '.stationTermM',
        	...
        	handler: function () {
        		if($(this).prop("checked")){
        			$("#expertFlagM1").prop("checked",false);
        			$("#expertFlagM2").prop("checked",false);
        			$("#expertFlagM3").prop("checked",false);
        			$("#expertFlagM4").prop("checked",false);
        			$("#expertFlagM5").prop("checked",false);
        			$("#expertFlagM1").attr("disabled","disabled");
        			$("#expertFlagM2").attr("disabled","disabled");
        			$("#expertFlagM3").attr("disabled","disabled");
        			$("#expertFlagM4").attr("disabled","disabled");
        			$("#expertFlagM5").attr("disabled","disabled");
        		}
        	}
        },{
        	el: '#expertFlagM',
        	...
        	handler: function () {
        		if($(this).prop("checked")){
        			$("#expertFlagM1").removeAttr("disabled");
        			$("#expertFlagM2").removeAttr("disabled");
        			$("#expertFlagM3").removeAttr("disabled");
        			$("#expertFlagM4").removeAttr("disabled");
        			$("#expertFlagM5").removeAttr("disabled");
        		}
        	}
        },{
        	el: '.expertFlagK',
