   		        ...
   		        },
            	{
 					...
 					render:function(data,type,row,meta){
 						...
 						if(row.checkTableFlag=='1'&&row.auditState!='1'){
 							ret = "<a href='javascript:void(0)' taskUid="+row.taskUid+" uid="+row.uid+" priPID="+row.priPID+" name='js-record' class='js-record'>打印检查记录表</a>";
 						}else{
 							ret = "<a href='javascript:void(0)' class='js_check'>检查表</a>";
 						}
