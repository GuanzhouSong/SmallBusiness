require(['component/iframeLayer', 'component/dataTable', 'common/util', 'common/http', 'handlebars','jquery.form', 'jquery','jquery.serialize','laydate','jquery.multiselect'], function (layer, dataTable, util, http,handlebars) {
    ...
    function initRegState(){
    	$("#regState").append("<option value='K,A,B,X,DA,Q'>存续</option>");
  		$("#regState").append("<option value='C'>撤销</option>");
  		$("#regState").append("<option value='D'>吊销</option>");
    	...
    	//全选
       	$('#regState').multipleSelect('setSelects',['K,A,B,X,DA,Q']);
    }
    ...
    function initDataTable() {
        ...
        table = dataTable.load({
            ...
            ajax: {
                url:'/syn/server/drcheck/specialcheck/searchlist.json',
                data:function(d){
    ...
    $("#search").click(function(){
    	...
    	searchParams.regState = regState.toString();
    ...
    function initScSpecialTotal(){
        http.httpRequest({
            url: '/syn/server/drcheck/specialcheck/searchcount.json',
            serializable: true,
            data: searchParams,
            type: 'post',
