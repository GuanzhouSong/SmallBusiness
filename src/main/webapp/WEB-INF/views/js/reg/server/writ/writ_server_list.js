...
require([
    ...
    //登记状态
    var regState = function(data){
        var txt = '-';
        if (data=="K"||data=="B"||data=="A"||data=="DA"||data=="Q"||data=="X")return txt = '存续';
        if (data == 'C')return txt = '撤销';
        if (data == 'D')return txt = '吊销';
        if (data=="XX"||data=="DX"||data=="QX")return txt = '注销';
        return txt;
    };
    ...
    $('#js-reset').click(function(){
        ...
        $('#regStateM').multipleSelect('setSelects',['K,B,A,DA,Q,X']);
    });
