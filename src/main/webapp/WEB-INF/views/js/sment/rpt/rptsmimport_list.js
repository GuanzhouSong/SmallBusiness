...
//    	'+window._CONFIG.deptCode == '3300' ? 'rptSmImportsjCount.json' : '
        ...
        table = dataTable.load({
            ...
            showIndex: true,
            ajax: {
                url:'/sment/server/rptsmentinfoall/'+window._CONFIG.chooseUrl,
                //async: false,
                data:function(d){
//                	console.log(2);
...
//                {data: 'cer90',className: 'right'}, 
            ...
            columnDefs: [                     
						...
						},
						{
						    ...
						    render: function (data, type, row, meta) {
						    	  if(data!=null&&data!=""){
						    		  if(data == 'eigIndustry1' || data == '1'){
						    			  return "信息经济产业";
						    		  }else if(data == 'eigIndustry2' || data == '2'){
						    			  return "环保产业";
						    		  }
							    	  else if(data == 'eigIndustry3' || data == '3'){
							    		  return "旅游产业";
							    	  }
							    	  else if(data == 'eigIndustry4' || data == '4'){
							    		  return "金融产业";
							    	  }
							    	  else if(data == 'eigIndustry5' || data == '5'){
							    		  return "健康产业";
							    	  }
							    	  else if(data == 'eigIndustry6'|| data == '6'){
							    		  return "时尚产业";
							    	  }
							    	  else if(data == 'eigIndustry7'|| data == '7'){
							    		  return "高端装备制造产业";
							    	  }
						    		  else if(data == 'eigIndustry8'|| data == '8'){
						    			  return "文化创意产业 ";
						    		  }else{
	                                      return data; 
						    		  }
...
//						        	console.log(3);
//							    	console.log("zxcount:"+zxcount+"rend");
//							    	console.log("lerepAgeTotal:"+lerepAgeTotal+"rend");
						    		  return util.toThousands(data.toFixed(0)); 
						    	}else{
						    		return "-";
						    	}
						    }
                ...
                if(data!=null&&data.length!=0){
	                ...
	                if(count==0||count=="0"){ //新设企业平均注册资本
	                	$( api.column( 14).footer() ).html("0.00");
	                	 ...
	                	 //平均注册资本
	                     $( api.column( 14).footer() ).html(regcapPer.toFixed(4))
	             }
	                if(lerepAgeTotal==0 || lerepAgeTotal=="0"){
	                	$( api.column( 15).footer() ).html("-");
		                 ...
		                 $( api.column(15).footer() ).html(avgAgePer.toFixed(0));
	                }
                }else{
                	for(var c=1;c<18;c++){ 
